...
ROCKCHIP_RKBIN_BUILD_DIR = $(BUILD_DIR)/rkbin

define ROCKCHUP_RKBIN_BUILD_DIR_SYMLINK
	ln -sf $(@D) $(ROCKCHIP_RKBIN_BUILD_DIR)
endef

ROCKCHIP_RKBIN_POST_EXTRACT_HOOKS += ROCKCHUP_RKBIN_BUILD_DIR_SYMLINK
